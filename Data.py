...
#                 indep = df['INDEP'].dropna().values
#                 dep = df['DEP'].dropna().values
...
# def main():
#     directory = '/Users/gabrielhernandez/Desktop/Alabama Docs/Research'  # Change this to your actual directory path
#     results_df, no_data_df = process_files(directory)
#     results_df.to_csv('trendline_results.csv', index=False)
#     no_data_df.to_csv('no_data_files.csv', index=False)
...
#     results_df.to_csv('trendline_results.csv', index=False)
#     no_data_df.to_csv('no_data_files.csv', index=False)
#     print("Processing complete. Results saved to 'trendline_results.csv' and 'no_data_files.csv'.")
